  ...
  Widget build(BuildContext context) {
    return FittedBox(
      child: Container(
        ...
        width: widget.direction == Axis.horizontal ? 230.0 : 70.0,
        height: widget.direction == Axis.horizontal ? 70.0 : 230.0,
        child: Material(
          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                ...
                child: Icon(Icons.remove, size: 40.0, color: Colors.black),
              ),
              Positioned(
